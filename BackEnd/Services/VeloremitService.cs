...
namespace BackEnd.Services
{
...

    {
        ...
        public async Task<GetExchangeRateDTO> GetExchangeRateAsync()
...

        {
            ...
            if (httpResponse.IsSuccessStatusCode)
            {
                ...
                if (rateResponse.status) {
                    return new ExchangeRateDTO(rate: rateResponse.data.exchangeRate, fromCurrency: rateResponse.data.fromCurrency, toCurrency: rateResponse.data.toCurrency);
                }
            }
            return null;
        }
    ...
    public class IveloremitService
    {
    }
}